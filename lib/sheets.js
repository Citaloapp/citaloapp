...
// ── FIX: columnas corregidas para coincidir con el Sheet de PROFESIONALES ──
export async function crearProfesionalActivo(datos) {
  ...
  const row = [
    ...
    'true',                              // L: activo
    '',                                  // M: dias_atencion (se completa después)
    '',                                  // N: horario_inicio (se completa después)
    '',                                  // O: horario_fin (se completa después)
